...
Works with any VectorStore implementation (InMemory, LlamaIndex, OpenSearch).
"""

from typing import Any

from .schemas import RetrievedExcerpt
from .vector_store import InMemoryVectorStore, VectorStoreProtocol


class PolicyRetriever:
    """Retrieves relevant policy excerpts by semantic similarity and metadata filters."""

    def __init__(self, vector_store: VectorStoreProtocol | InMemoryVectorStore):
